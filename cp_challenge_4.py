...
conn.create_volume(size=1, display_name='database_challenge4', description='A database volume for the challenge 4')
...
instance = conn.get_server('challenge4')
volume = conn.get_volume('database_challenge4')
